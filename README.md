...
```
sudo pacman -Syu --needed base-devel cmake boost openssl zeromq unbound libsodium libunwind xz readline expat miniupnpc python3 ccache doxygen graphviz qt5-tools hidapi libusb protobuf systemd
```
