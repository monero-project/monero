...
# This module locates libusb as published by:
#   http://libusb.sf.net and
#   http://libusb-win32.sf.net
#
# It utilizes PkgConfig when available and supported, otherwise performs
# an independent search. If LibUSB_ROOT_DIR environment variable is set,
# it will be used as the base path.
#
# Defined standard variables:
#   LibUSB_FOUND:        true if LibUSB is found
#   LibUSB_HEADER_FILE:  location of the C header file
#   LibUSB_INCLUDE_DIRS: directory containing the include file
...
# at https://github.com/IntelRealSense/librealsense to enhance this module.
...
if(PKGCONFIG_LIBUSB_FOUND)
    ...
    if(${CMAKE_SYSTEM_NAME} STREQUAL "Windows")
        ...
        # Use the lib compiled with the same compiler.
        if(MSVC)
            if(WIN32)
