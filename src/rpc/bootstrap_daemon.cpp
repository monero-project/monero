...
#define XEQ_DEFAULT_LOG_CATEGORY "daemon.rpc.bootstrap_daemon"
...
namespace cryptonote
{
  ...
  bootstrap_daemon::bootstrap_daemon(const std::string &address, boost::optional<epee::net_utils::http::login> credentials)
