...
complete -c monerod -l tx-proxy -r -d "Send local txes through proxy: <network-type>,<socks-ip:port>[,max_con nections][,disable_noise] i.e. \"tor,socks5://127.0.0.1:9050,100,disable_noise\""
complete -c monerod -l tor-stream-isolation -d "Generate SOCKS5 isolation credentials for --proxy; Tor --tx-proxy traffic is always isolated separately"
