...
complete -c monerod -l tx-proxy -r -d "Send local txes through proxy: <network-type>,<socks-ip:port>[,max_connections][,disable_noise] i.e. \"tor,127.0.0.1:9050,100,disable_noise\""
...
complete -c monerod -l i2p-sam -r -d "Use I2P router's SAM bridge for proxying network traffic: <router-ip:sam-port>[,max_out_connections[,max_in_connections]] i.e. \"127.0.0.1:7656,32,0\" (0 disables that direction)"
...
complete -c monerod -l limit-rate-down -r -d "Set limit-rate-down [kB/s]. Default: 32768"
...
complete -c monerod -l rpc-ssl-private-key -r -k -a "(__fish_complete_suffix .key)" -d "Path to a PEM format private key"
complete -c monerod -l rpc-ssl-certificate -r -k -a "(__fish_complete_suffix .crt)" -d "Path to a PEM format certificate"
