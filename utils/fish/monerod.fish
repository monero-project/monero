...
complete -c monerod -l sync-pruned-blocks -d "Allow syncing from nodes with only pruned blocks (obsolete, now default for pruned nodes)"
complete -c monerod -l no-sync-pruned-blocks -d "Download the full contents of all blocks, even when pruning"
